...
enum StarType: String {
    ...
    case emptyStar = "star", halfStar = "star.leadinghalf.fill", filledStar = "star.fill"
    
    var toImage: UIImage { return UIImage(systemName: self.rawValue)!.withRenderingMode(.alwaysTemplate) }
}
